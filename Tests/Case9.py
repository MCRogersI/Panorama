...
Sf.createSku(db, 1,'Telescopic', 2.01, 100,219)
Sf.createSku(db, 2,'Glass Pane Knob', 6.43, 200,220)
Sf.createSku(db, 3,'Lower chamber-9', 4.77, 150,234)
Sf.createSku(db, 4,'Upper chamber-9', 3.07, 150,243)
Sf.createSku(db, 5,'Lock for latch', 12.03, 100,251)
Sf.createSku(db, 6,'Profile joint unit plastic bag', 4.93, 180,268)
Sf.createSku(db, 7, 'Screw M4x14 tx20 A2 DIN965', 0.07, 50,0)
Sf.createSku(db, 8, 'Fastening Bead 10mm transparent', 2.51, 50,0)
Sf.createSku(db, 9, 'Screws for Water Sill', 0.69, 50,0)
Sf.createSku(db, 10, 'Lock Keeper, wall side', 6.52, 50,0)
...
Sf.createPurchases(db,[(7,1000)],date(2017, 8, 8))
Sf.createPurchases(db,[(8,100)],date(2017, 8, 8))
