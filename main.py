...
while True:
		...
		if(opt == '1'):
			ETu.employees_teams_console(db, ETf.CreateEmployee, ETf.PrintEmployees, ETf.EditEmployee, ETf.PrintEmployeesSkills, ETf.PrintSelectSkill, ETf.DeleteEmployee)
		if(opt == '2'):
