...
while True:
		...
		if(opt == '2'):
			Pu.projects_console(db, Pf.CreateProject, Pf.PrintProjects,Pu.EditProject, Pf.DeleteProject, Pf.CreateTask, Pf.EditTask, Pf.AssignTask, Pf.DeleteTask, Pf.PrintTasks, Pf.FailedTask)
		else:
