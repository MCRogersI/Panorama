...
# Pf.CreateProject(db, 3, 'NS/NR', 'NS/NR', 'NS/NR', 15, estimated_cost = 400,)
# Pf.EditProject(db, 1, new_real_linear_meters = 21, new_real_cost = 345)
...
Pf.CreateTask(db, 1, 1, 1, d.datetime(2014, 12, 26), d.datetime(2014,12,31))
