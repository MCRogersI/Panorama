...
# Pf.CreateTask(db, 4, 2, 2, d.datetime(2014, 12, 16), d.datetime(2014,12,17))
# Pf.CreateTask(db, 5, 3, 2, d.datetime(2014, 12, 18), d.datetime(2014,12,25))
# Pf.CreateTask(db, 1, 1, 2, d.datetime(2014, 12, 26), d.datetime(2014,12,31))
